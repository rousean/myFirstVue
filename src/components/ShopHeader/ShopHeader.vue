<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="changeShow">
      <img class="content-image" :src="info.avatar" alt="图片">
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">{{info.description}}
              <span>约{{info.deliveryTime}}分钟</span></span>
          <span class="shop-message-detail">距离{{info.distance}}</span></div>
      </div>
    </div>
    <div class="shop-header-discounts" v-if="info.supports" @click="changeFold">
    ...
    <div class="shop-brief-modal" v-show="isShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="changeShow">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="isFold">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="changeFold">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
